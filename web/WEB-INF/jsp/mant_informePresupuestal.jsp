...
<html>
    ...
    <body>
        ...
        <div class="container col-sm-8" style="font-size: small">
            ...
            <form:form action="buscarPIPforIP.html" method="POST" modelAttribute="busquedapip">
            ...
            <table class="table table-striped" style="font-size: smaller; padding-left: 10px; padding-right: 10px;">
                ...
                <c:forEach var="epip" items="${list}">
                    <tr style="text-align: center;">
                        <td>${epip.codigo}</td>
                        <td>${epip.nombreSector}</td>
                        <td>${epip.fechaInforme}</td>
                        <td><a href="editInformePresupuestal/${epip.id}.html">Ver</a></td>
                    </tr>
                </c:forEach>
            </table>
            </form:form>
